...
export class AdListComponent implements OnInit {
  ...
  createAdModel(): AdModel {
    ...
    this.adModel.attachedAssetsInCloudStorageId =
      "8b8174ed-dc5d-4433-b41d-175625bd363d";
    this.adModel.attachedAssetsStoredInCloudBaseFolderPath =
      "https://github.com/chinnarao";
